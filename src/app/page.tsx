...
/* ============================================================
   QUICK START — multi-stack tabbed terminal
   ============================================================ */
function HowItWorksSection() {
  const stacks = [
    {
      ...
      lines: [
        { prompt: true, text: "npm install -g @core-line/cli", color: "#79c0ff" },
        { prompt: false, text: "✓ Core-Line CLI installed", color: "#3fb950" },
        { prompt: true, text: "cl init my-project", color: "#79c0ff" },
        { prompt: false, text: "✓ Project structure generated", color: "#3fb950" },
        { prompt: false, text: "✓ Layer config applied", color: "#3fb950" },
        { prompt: true, text: "cl generate module user", color: "#79c0ff" },
        { prompt: false, text: "→ src/modules/user/user.port.ts", color: "#e3b341" },
        { prompt: false, text: "→ src/modules/user/user.flow.ts", color: "#e3b341" },
        { prompt: false, text: "→ src/modules/user/user.source.ts", color: "#e3b341" },
    ...
    },
    {
      ...
      lines: [
        ...
        { prompt: false, text: "✓ Core-Line CLI installed", color: "#3fb950" },
        { prompt: true, text: "cl init my-service", color: "#79c0ff" },
        { prompt: false, text: "✓ Go module structure generated", color: "#3fb950" },
        { prompt: true, text: "cl generate module user", color: "#79c0ff" },
        { prompt: false, text: "→ internal/user/user_port.go", color: "#e3b341" },
        { prompt: false, text: "→ internal/user/user_flow.go", color: "#e3b341" },
        { prompt: false, text: "→ internal/user/user_source.go", color: "#e3b341" },
    ...
    },
    {
      ...
      lines: [
        ...
        { prompt: false, text: "✓ Core-Line CLI installed", color: "#3fb950" },
        { prompt: true, text: "cl init my_service", color: "#79c0ff" },
        { prompt: false, text: "✓ Python package structure generated", color: "#3fb950" },
        { prompt: true, text: "cl generate module user", color: "#79c0ff" },
        { prompt: false, text: "→ src/user/user_port.py", color: "#e3b341" },
        { prompt: false, text: "→ src/user/user_flow.py", color: "#e3b341" },
        { prompt: false, text: "→ src/user/user_source.py", color: "#e3b341" },
    ...
    },
    {
      ...
      lines: [
        ...
        { prompt: false, text: "implementation 'io.coreline:cli:2.0'", color: "#a5d6ff" },
        { prompt: true, text: "cl init my-service", color: "#79c0ff" },
        { prompt: false, text: "✓ Maven/Gradle structure generated", color: "#3fb950" },
        { prompt: true, text: "cl generate module user", color: "#79c0ff" },
        { prompt: false, text: "→ src/main/java/.../UserPort.java", color: "#e3b341" },
        { prompt: false, text: "→ src/main/java/.../UserFlow.java", color: "#e3b341" },
        { prompt: false, text: "→ src/main/java/.../UserSource.java", color: "#e3b341" },
        { prompt: false, text: "→ src/main/java/.../UserBridge.java", color: "#e3b341" },
      ],
    },
    {
      id: "rust",
      ...
      lines: [
        ...
        { prompt: false, text: "✓ Core-Line CLI installed", color: "#3fb950" },
        { prompt: true, text: "cl init my_service", color: "#79c0ff" },
        { prompt: false, text: "✓ Cargo workspace structure generated", color: "#3fb950" },
        { prompt: true, text: "cl generate module user", color: "#79c0ff" },
        { prompt: false, text: "→ src/user/port.rs", color: "#e3b341" },
        { prompt: false, text: "→ src/user/flow.rs", color: "#e3b341" },
        { prompt: false, text: "→ src/user/source.rs", color: "#e3b341" },
  ...
  const [activeStack, setActiveStack] = useState(0);
  const active = stacks[activeStack];

  return (
    <section className="section-pad">
      <div className="container-main">
        <Reveal className="text-center" style={{ marginBottom: "64px" }}>
          <div className="text-label" style={{ marginBottom: "16px" }}>Quick Start</div>
          <h2 className="text-headline" style={{ marginBottom: "16px" }}>Up and running in minutes</h2>
          <p className="text-body" style={{ maxWidth: "480px", margin: "0 auto" }}>
            Core-Line supports every major backend stack. Pick yours and get started instantly.
          </p>
        </Reveal>

        <Reveal delay={0.15}>
          <div className="terminal-saas" style={{ maxWidth: "780px", margin: "0 auto" }}>
            {/* Header with traffic lights + tab label */}
            <div className="terminal-header">
              ...
              <span className="terminal-tab" style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                <IconTerminal /> bash — {active.lang}
              </span>
              <span className="text-label">{active.lang}</span>
            </div>
              ...
              {stacks.map((stack, i) => (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "100px",
                    border: "1px solid",
                    borderColor: activeStack === i ? "var(--border-strong)" : "transparent",
                    background: activeStack === i ? "var(--bg-elevated)" : "transparent",
                    color: activeStack === i ? "var(--text-primary)" : "var(--text-muted)",
                    fontSize: "0.8125rem",
                    fontWeight: activeStack === i ? 600 : 400,
                    cursor: "pointer",
              ...
              >
                {active.lines.map((line, i) => (
                  <div key={i} style={{ marginBottom: "4px", display: "flex", gap: "8px" }}>
                    {line.prompt && <span style={{ color: "#6e7681", flexShrink: 0 }}>$</span>}
                    {!line.prompt && <span style={{ color: "transparent", flexShrink: 0, userSelect: "none" }}>$</span>}
                    <span style={{ color: line.color, fontFamily: "var(--font-jetbrains-mono), monospace", fontSize: "0.8125rem" }}>{line.text}</span>
                  </div>
                ))}
              </motion.div>
            </div>
